                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{{ $inductionDetail->title }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="check_box">
                                                        ...
                                                        <div class="form-group">
                                                          <input name="uploadFile" type="file" data-default-file="{{ asset('public/assets/Induction/image/'.$inductionDetail->uploadFile.'')}}" class="dropify" data-height="100" />
                                                        </div>
                                                    </div>
