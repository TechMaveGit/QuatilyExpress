                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control secondcls" name="totalPayable" value="{{ $finalpayamnnt+$shiftView->getShiftMonetizeInformation->fuelLevyPayable+$shiftView->getShiftMonetizeInformation->extraPayable }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
