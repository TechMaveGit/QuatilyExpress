                                               ...
                                               <div class="col-lg-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if($shiftView->getFinishShifts->dayHours ?? 0 !='0')
                                                     ...
                                                     @endphp
                                                        @endif
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $day ??'0' }}"  aria-describedby="emailHelp" placeholder="" readonly>
                                               ...
                                               <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    @if($shiftView->getFinishShifts->nightHours ?? 0 !='0')
                                                     ...
                                                     @endphp
                                                    @endif
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $night ??'0' }}" aria-describedby="emailHelp" placeholder="" readonly>
