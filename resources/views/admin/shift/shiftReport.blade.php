                                ...
                                <div class="table_box" id="shiftTable_Container">
                                            ...
                                            @foreach ($shift as $key => $allshift)
                                                <tr class="border-bottom">
                                                    ...
                                                    <td class="td column-driver">
                                                        {{ $allshift->getDriverName->userName ?? 'N/A' }}</td>
                                    ...
                                    if ($allshift->finishStatus=='0') { ?>
                                                    ...
                                                    @if ($allshift->getFinishShift)
                                                        @php
                                                            $daySum =
                                                                floatval($allshift->getFinishShift->dayHours) ?? 0;
                                                            $nightHours =
                                                                floatval($allshift->getFinishShift->nightHours) ?? 0;
                                                            $weekendHours =
                                                                floatval($allshift->getFinishShift->weekendHours) ?? 0;
                                                        @endphp
                                                    @endif
                                                    ...
                                                    @php
                                                        $chargeDayShift =
                                                            ($allshift->getClientReportCharge
                                                                ->hourlyRateChargeableDays ??
                                                                0) *
                                                            ($allshift->getFinishShifts->dayHours ?? 0);
                                                        $chargeNight =
                                                            ($allshift->getClientReportCharge
                                                                ->ourlyRateChargeableNight ??
                                                                0) *
