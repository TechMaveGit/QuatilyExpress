                                        ...
                                        @endif
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"  class="form-control" name="scannerName" id="exampleInputEmail1" value="{{ $shiftView->parcelsToken }}"  @if($shiftView->finishStatus =='5') disabled @else @endif aria-describedby="emailHelp" placeholder="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control datetime_picker"
                                                    value="{{ \Carbon\Carbon::parse($finishshifts->created_at)->format('Y-m-d H:i') }}"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="action_btns text-end">
                                                        <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Save</button>
                                                         <a href="{{ route('admin.shift') }}" class="theme_btn btn-primary btn"><i class="uil-list-ul"></i> List</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        @php
                                                            ...
                                                            if ($shiftView->priceOverRideStatus == '1') {
                                                                ...
                                                                $night = ($priceCompare ? ($priceCompare->hourlyRatePayableNight ?? 0) * ($shiftView->getFinishShifts ? $shiftView->getFinishShifts->nightHours : 0) : 0);
                                                            } else {
                                                                if ($shiftView->getFinishShifts && $shiftView->getFinishShifts->nightHours ?? 0 != '0') {
                                                                    $night = $shiftView->getClientCharge->hourlyRatepayableNight ?? 0  * $shiftView->getFinishShifts->nightHours ?? 0;
                                                                }
                                                            }
                                                        @endphp
                                                        ...
                                                        @else
                                                            @php
                                                                ...
                                                                if ($shiftView->getFinishShifts && $shiftView->getFinishShifts->saturdayHours != '0') {
                                                                    $saturday = $shiftView->getClientCharge->hourlyRatePayableSaturday * $shiftView->getFinishShifts->saturdayHours;
                                                                }

                                                                if ($shiftView->getFinishShifts && $shiftView->getFinishShifts->sundayHours) {
                                                                    $sunday = $shiftView->getClientCharge->hourlyRatePayableSunday  * $shiftView->getFinishShifts->sundayHours;
                                                                }
                                                                $finalAmount=$saturday +  $sunday;
                                    ...
                                    <div class="top_dt_sec">
                                        ...
                                        <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" step="0.1" class="form-control secondcls" id="first" onInput="edValueKeyPrs('a')" name="amountPayablePerService" @if($shiftView->finishStatus =='5') disabled @else @endif  value="" aria-describedby="emailHelp" placeholder="" readonly>
                                                    <input type="hidden" id="hiddenPrice" value="{{ round($day ?? 0,2)+ round($night ?? 0,2) + round($finalAmount,2) }}"/>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                               ...
                                               <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" step="0.1" value="{{ round($shiftView->payAmount?? 0 ,2) }}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"  class="form-control secondcls" name="totalPayable" @if($shiftView->finishStatus =='5') disabled @else @endif  id="subtotal" aria-describedby="emailHelp" placeholder="">
                                                </div>
