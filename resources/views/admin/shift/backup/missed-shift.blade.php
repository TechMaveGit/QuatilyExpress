                                        ...
                                        <div id="wizard1s">
                                            ...
                                            <section>
                                                ...
                                                <form action="{{ route('admin.shift.missed.shift') }}" method="post"/> @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                ...
                                                                <input type="date" name="start_date" class="form-control" id="start-date"  aria-describedby="emailHelp" data-input required>
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <input type="date" name="end_date" class="form-control" id="end-date" aria-describedby="emailHelp" data-input readonly required>
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <div class="check_box">
                                                                    ...
                                                                    <select class="form-control select2 form-select" name="costCenter"  onchange="getCenterBase(this)" id="appendCostCenter" data-placeholder="Choose one" required>
                                                ...
                                                <div class="col-lg-3">
                                                        ...
                                                        <input type="number" name="odometer_start_reading" id="odometer_start_reading" oninput="checkRego()" min="0" class="form-control" aria-describedby="emailHelp" placeholder="" fdprocessedid="enssm" required>
                                                ...
                                                <div class="col-lg-3">
                                                        ...
                                                        <input type="number" min="0" class="form-control" name="odometer_finish_reading" value="{{ $odometer_finish_reading  }}" id="odometer_finish_reading" aria-describedby="emailHelp" placeholder="" onkeypress="checkOdometerReading(event)" required>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="parcelsToken"  value="{{ $parcelsTaken }}"  id="ParcelsTaken" min="0"  aria-describedby="emailHelp" placeholder="" required>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"  value="{{ $parcel_delivered }}" onkeypress="parcelDelivered(event)" id="parcel_delivered" min="0"  name="parcel_delivered" aria-describedby="emailHelp" placeholder="" required>
                                                        <div id="message_"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-label" for="exampleInputEmail1">Comment <span class="red">*</span></label>

                                                        <input type="text" class="form-control"  name="comment" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
