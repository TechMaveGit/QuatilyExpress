                                           ...
                                           <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="#basicDate" value="{{ $shiftView->created_at ??'N/A' }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($finishshifts->created_at)->format('Y-m-d H:i') }}" placeholder="" readonly>
                                                </div>
                                            </div>
                                    ...
                                    <div class="top_dt_sec">
                                        ...
                                        {{-- @if ($driverRole->role_id!='33') --}}
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $dayHours1 }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                               ...
                                               <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $nightHour1 }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                               ...
                                               <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $shiftView->getFinishShifts->saturdayHours??'0' }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                               ...
                                               <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $shiftView->getFinishShifts->sundayHours??'0' }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                               ...
                                               <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $shiftView->getFinishShifts->weekendHours??'0' }} "  aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                               ...
                                               <div class="col-lg-3">
                                                ...
                                                @if ($shiftView->priceOverRideStatus == '1')
                                                    @php
                                                         $priceCompare = DB::table('personrates')->where('type', $shiftView->vehicleType)->where('personId', $shiftView->driverId)->first();
                                                        $day = ($priceCompare ? $priceCompare->hourlyRatePayableDays : 0) * $shiftView->getFinishShifts->dayHours ?? 0;
                                                    @endphp
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $day }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                @else

                                                    @if($shiftView->getFinishShifts->dayHours ?? 0 !='0')
                                                     @php
                                                        $day = ($shiftView->getClientCharge->hourlyRatePayableDay ?? 0) * ($shiftView->getFinishShifts->dayHours ?? 0);
                                                     @endphp
                                                     @else
                                                     @php
                                                     $day = 0
                                               ...
                                               <div class="col-lg-3">
                                                ...
                                                @if ($shiftView->priceOverRideStatus == '1')
                                                    ...
                                                    //   echo "ok"; die;
                                                        $priceCompare = DB::table('personrates')->where('type', $shiftView->vehicleType)->where('personId', $shiftView->driverId)->first();
                                                        $night = ($priceCompare ? $priceCompare->hourlyRatePayableNight : 0) * $shiftView->getFinishShifts->nightHours ?? 0;
                                                    @endphp
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $night }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                @else

                                                    @if($shiftView->getFinishShifts->nightHours ?? 0 !='0')
                                                     @php
                                                          $night = ($shiftView->getClientCharge->hourlyRatePayableNight ?? 0) * ($shiftView->getFinishShifts->nightHours ?? 0);
                                                     @endphp
                                                     @else
                                                     @php
                                                     $night = 0
                                                    ...
                                                    @if ($shiftView->priceOverRideStatus == '1')
                                                        @php
                                                            $priceCompare = DB::table('personrates')
                                                                ->where('type', $shiftView->vehicleType)
                                                                ->where('personId', $shiftView->driverId)
                                                                ->first();

                                                            $saturday = ($priceCompare ? ($priceCompare->hourlyRatePayableSaturday ?? 0) * ($shiftView->getFinishShifts ? $shiftView->getFinishShifts->saturdayHours : 0) : 0);
                                                            $sunday = ($priceCompare ? ($priceCompare->hourlyRatepayableSunday ?? 0) * ($shiftView->getFinishShifts ? $shiftView->getFinishShifts->sundayHours : 0) : 0);
                                                            $finalAmount=$saturday +  $sunday;
                                                        @endphp
                                                        <input type="text" class="form-control" id="exampleInputEmail1" value="{{ round($saturday + $sunday ,2) }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                    @else
                                                        @php
                                                            $saturday = 0;
                                                            $sunday = 0;
                                                            ...
                                                            if ($shiftView->getFinishShifts && $shiftView->getFinishShifts->saturdayHours != '0') {
                                                                $saturday = ($shiftView->getClientCharge->hourlyRatePayableSaturday ?? 0) * ($shiftView->getFinishShifts->saturdayHours ?? 0);
                                                            }

                                                            if ($shiftView->getFinishShifts && $shiftView->getFinishShifts->sundayHours != '0') {
                                                                $sunday = ($shiftView->getClientCharge->hourlyRatePayableSunday ?? 0) * ($shiftView->getFinishShifts->sundayHours ?? 0);
                                                            }
                                                            $finalAmount=$saturday +  $sunday;
                                                        @endphp

                                                        <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $saturday + $sunday }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                @endphp
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1" value="{{ round($chargeDayShift,2) }}" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" value="{{ round($chargeNight,2) }}"  aria-describedby="emailHelp" placeholder="" readonly>
                                            </div>
                                        </div>
                                        ...
                                        @php
                                            $saturday = ($shiftView->getClientCharge->hourlyRateChargeableSaturday ?? 0)  * ($shiftView->getFinishShifts->saturdayHours ?? 0) ;
                                        @endphp
                                        @else
                                        @php
                                            $saturday=0;
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" value="{{ round($saturday,2) }}"  aria-describedby="emailHelp" placeholder="" readonly>
                                            </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" value="{{ round($sunday,2) }}"  aria-describedby="emailHelp" placeholder="" readonly>
                                            </div>
                                     ...
                                     <div class="top_dt_sec">
                                        ...
                                        <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="amountPayablePerService" value="{{ round($day,2) + round($night,2) + round($finalAmount,2) }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                           ...
                                           <div class="col-lg-6">
                                               ...
                                               <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="totalChargeable" value="{{ round($shiftView->chageAmount ?? 0, 2) }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" readonly>
                                                </div>
                                               ...
                                               <div class="col-lg-12">
                                                ...
                                                <textarea class="form-control mb-4" name="comments" placeholder="Textarea" readonly rows="4">{{ $shiftView->getShiftMonetizeInformation->comments	??'' }}</textarea>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control mb-4" name="approvedReason" placeholder="Textarea" readonly rows="4">{{ $shiftView->getShiftMonetizeInformation->approvedReason	??'' }}</textarea>
