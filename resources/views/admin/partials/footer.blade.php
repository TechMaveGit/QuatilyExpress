            ...
            <div class="tab-pane" id="sidebar-side2">
               <div class="list-group list-group-flush">
                  ...
                  <div class="list-group-item d-flex align-items-center">
                     ...
                     <div class="">
                        <a href="chat.html">
                           <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Simon Sais
                           </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Route Estimate</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i
                  class="ti-close"></i></button>
         </div>
         <div class="modal-body">
            <div class="route_estimate_dt">
               <ul>
                  <li><span>Travel Time</span> <span>35 min</span></li>
                  <li><span>Total Time</span> <span>35 min</span></li>
                  <li><span>Travel Distance</span> <span>10 Km</span></li>
               </ul>
            </div>
         </div>
         <div class="modal-footer">
            <div class="box_optimize">
               <div class="optimize">
                  <p>Would you like to optimize your route? </p>
               </div>
               <div class="optimize">
...
<!-- Modal -->
<div class="modal fade" id="parcel_deliver" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <form action="{{ route('admin.package.Deliver') }}" method="post"> @csrf
         <div class="modal-content">
            <div class="modal-header">
               <h1 class="modal-title fs-5" id="exampleModalLabel">Parcel Deliver </h1>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i
                     class="ti-close"></i></button>
            </div>
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="mb-3">
                        <label class="form-label" for="exampleInputEmail1">Receiver’s Name <span
                              class="red">*</span></label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="receiverName"
                  ...
                  <div class="col-lg-12">
                     <div class="mb-3">
                        <label class="form-label" for="exampleInputEmail1">Scan Parcel <span
                              class="red">*</span></label>
                        <input type="text" class="form-control" name="scanParcel" id="exampleInputEmail1"
                           aria-describedby="emailHelp" placeholder="">
                        <div class="scan_icon">
                  ...
                  <div class="col-lg-12">
                     <div class="check_box">
                        <label class="form-label" for="exampleInputEmail1">Upload Image <span
                              class="red">*</span></label>
                        <div class="form-group">
                           <input name="uploadImage" type="file" class="dropify" data-height="100" />
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="container">
      <div class="row align-items-center flex-row-reverse">
         <div class="col-md-12 col-sm-12 text-center">
            Copyright © <span id="year"></span> <a href="#">Quality Express</a>. Designed with <span
               class="fa fa-heart text-danger"></span> by <a href="https://www.techmavesoftware.com/"> TechMave Software
...
<!-- <script>
  $(document).ready(function() {
    ...
    columns.forEach(function(column, index) {
      columnVisibilityDropdown += '<div class="dropdown-item"><label><input type="checkbox" class="column-checkbox" data-column="' + index + '" checked>' + $(column).text() + '</label></div>';
    });
...
<script>
   function addItem(shiftId) {
      $('#shiftId').val(shiftId);
      $("#shift_approve").modal('show');
   }
</script>
...
<script>
    var endDateInput = document.getElementById('end-date1');
    // Add click event listener to the text
    endDateInput.addEventListener('click', function() {
      // Trigger a click event on the input field
      endDateInput.click();
...
<script>
    var endDateInput = document.getElementById('myDatetimeInput');
    // Add click event listener to the text
    endDateInput.addEventListener('click', function() {
      // Trigger a click event on the input field
      endDateInput.click();
...
<script>
    var endDateInput = document.getElementById('dateFinish');
    // Add click event listener to the text
    endDateInput.addEventListener('click', function() {
      // Trigger a click event on the input field
      endDateInput.click();
