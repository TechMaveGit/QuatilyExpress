                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="phonePrinciple" maxlength="13" autocomplete="off" aria-describedby="emailHelp" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exampleInputEmail1">Mobile Phone <span class="red">*</span></label>
                                                <input type="number" class="form-control" name="mobilePhone" maxlength="13" autocomplete="off" aria-describedby="emailHelp" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="title_head">
                                                ...
                                                {{-- <input type="number" id="numeric-input" name="numeric-input" step="any" placeholder="1.2 or 12">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number"  class="form-control thirdcls"  id="hourlyRate"  step="any"  placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number" class="form-control thirdcls " id="hourlyRateChargeable" aria-describedby="emailHelp" placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number" class="form-control thirdcls" id="HourlyRateChargeableSaturday" aria-describedby="emailHelp" placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number"  class="form-control thirdcls"  id="HourlyRateChargeableSunday" aria-describedby="emailHelp" placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Day</label>
                                                        <input type="number" class="form-control secondcls"  id="HourlyRatePayableDay" aria-describedby="emailHelp" placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number" class="form-control secondcls" id="HourlyRatePayableNight" aria-describedby="emailHelp" placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number" class="form-control secondcls" id="HourlyRatePayableSaturday" aria-describedby="emailHelp" placeholder="">
                                                 ...
                                                 <div class="col-lg-3">
                                                    <div class="mb-3">
                                                       ...
                                                       <input type="number"  class="form-control secondcls"  id="HourlyRatePayableSunday" aria-describedby="emailHelp" placeholder="">
