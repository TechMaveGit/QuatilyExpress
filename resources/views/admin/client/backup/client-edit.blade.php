   ...
   <div class="modal fade zoomIn" id="editRate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 62%;">
        <div class="modal-content">
            ...
            {{-- <form action="{{route('admin.delete.cleaners')}}" method="post"/>@csrf --}}
            {{-- <div class="modal-body">
                <div class="mt-2 text-center">
                                          ...
                                          <div class="row">
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   ...
                                                   <p id="clientAddressError" style="display: none">Please Add Zip Code</p>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   ...
                                                   <input type="text" class="form-control" name="unit" id="exampleInputUnit" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   ...
                                                   <input type="text" class="form-control" name="addressstate" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-lg-12">
                                          <div class="row align-items-center">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Chargeable Day </label>
                                                   <input type="text" class="form-control chargeClr" name="hourlyRate" min="0" step="any" id="hourlyRateChargeableDays" aria-describedby="emailHelp" placeholder="">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Chargeable Night</label>
                                                   <input type="text" class="form-control chargeClr" name="hourlyRateChargeable" min="0" id="ourlyRateChargeableNight" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Chargeable Saturday</label>
                                                   <input type="text" class="form-control chargeClr" name="HourlyRateChargeableSaturday" min="0" id="hourlyRateChargeableSaturday" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Chargeable Sunday</label>
                                                   <input type="text" class="form-control chargeClr" name="HourlyRateChargeableSunday" min="0" id="hourlyRateChargeableSunday" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Day</label>
                                                   <input type="text" class="form-control chargePay" name="HourlyRatePayableDay" min="0" id="hourlyRatePayableDay" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Night</label>
                                                   <input type="text" class="form-control chargePay" name="HourlyRatePayableNight" id="hourlyRateChargeable" min="0" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Saturday</label>
                                                   <input type="text" class="form-control chargePay" name="HourlyRatePayableSaturday" min="0" id="HourlyRatePayableSaturday" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="mb-3">
                                                   <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Sunday</label>
                                                   <input type="text" class="form-control chargePay" name="HourlyRatePayableSunday" min="0" id="HourlyRatePayableSunday" aria-describedby="emailHelp" placeholder="">
                                                </div>
                                             </div>
                                             <div class="col-lg-12">
                                                <div class="search_btn text-end">
...
<script>
   $('#saveClient').on('submit',function(e) {
          ...
          var clientBase = $.trim($('#clientAddressCode').val());
            if (clientBase  === '') {
