                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputEmail1" value="{{old('extra_rate_per_hour')}}" min="0" autocomplete="off" name="extra_rate_per_hour" aria-describedby="emailHelp" placeholder="" required>
                                            </div>
                                        </div>
