                        ...
                        <div class="card show_portfolio_tab">
                            <div class="card-header">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a onclick="clickMenu()" data-bs-toggle="tab" aria-expanded="true"
                                            class="nav-link ">
                                    ...
                                    <li class="nav-item">
                                        <a onclick="clickMenu()" data-bs-toggle="tab" aria-expanded="false"
                                            class="nav-link">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="exampleInputEmail1">Phone
                                                                    Aux</label>
                                                                <input class="form-control" name="phoneaux"
                                                                    min="0" autocomplete="off"
                                                                    value="{{ old('phoneaux') }}"
                                                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                                    type = "number" maxlength = "12" placeholder="">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="exampleInputEmail1" name="tfn"
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="exampleInputEmail1" name="abn"
                                                                    autocomplete="off" value="{{ old('abn') }}"
                                                                    aria-describedby="emailHelp" placeholder="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="exampleInputEmail1">Extra
                                                                    Rate (Per Hour) <span class="red">*</span></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="exampleInputEmail1">Zip
                                                                        Code</label>
                                                                    <input type="text" class="form-control"
                                                                        id="exampleInputEmail1"
                                                                        aria-describedby="emailHelp" placeholder="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="add_address text-end">
                                                            <a href="#" class="theme_btn btn btn-primary "
                                                                id="add_address_btn">+ Add Address</a>
                                                            ...
                                                            <table class="table table-bordered text-nowrap mb-0">
                                                                <thead class="border-top">
                                                                    <tr>
                                                                        ...
                                                                        <th class="bg-transparent border-bottom-0">Unit
                                                                        </th>
                                                                        ...
                                                                        <th class="bg-transparent border-bottom-0">City
                                                                        </th>
                                                                ...
                                                                <div class="check_box">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2 form-select"
                                                                            ...
                                                                            <option value="2">Email Service Due
                                                                            </option>
                                                                            <option value="2">Email Inspection Due
                                                                            </option>
                                                        ...
                                                        <table id="basic-datatable"
                                                            ...
                                                            <thead class="border-top">
                                                                <tr>
                                                                    ...
                                                                    <th class="bg-transparent border-bottom-0">Situation
                                                                    </th>
                                                                    <th class="bg-transparent border-bottom-0"
                                                                        style="width: 5%;">Action</th>
                                                                </tr>
                                                        ...
                                                        <div class="row align-items-center">
                                                                ...
                                                                <div class="check_box">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2 form-select"
                                                                            ...
                                                                            <option value="2">OWN CAR NIGHT SHIFT
                                                                            </option>
                                                                            <option value="2">OWN UTE</option>
                                                                            <option value="2">PUSH BIKE</option>
                                                                            <option value="2">T1 REFRIGERATED VAN
                                                                            </option>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="search_btn text-end">
                                                                    <a href="#" class="btn btn-primary srch_btn">+
                                                                        Add Rate</a>
                                                                    <a href="#" class="btn btn-info srch_btn"><i
