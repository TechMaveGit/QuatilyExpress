                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="check_box">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="edittype" name="vehicleType" data-placeholder="Choose one" tabindex="-1" aria-hidden="true">
                                ...
                                <span id="VehicleTypeErrorss" class="text-danger" hidden="">Please select any one type.</span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="hourlyRatePayableNight" id="hourlyRatePayableNight" min="0" class="form-control fc-datepicker" aria-describedby="emailHelp" placeholder="">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                 ...
                                 <input type="text" name="hourlyRatePayableSaturday" id="hourlyRatePayableSaturday" min="0" class="form-control fc-datepicker" aria-describedby="emailHelp" placeholder="">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="hourlyRatePayableSunday" id="hourlyRatePayableSunday" min="0" class="form-control fc-datepicker" aria-describedby="emailHelp" placeholder="">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label" for="exampleInputEmail1">Extra Hourly Rate</label>
                                        <input type="text" name="extraHourlyRate" id="extraHourlyRate" min="0" class="form-control fc-datepicker" aria-describedby="emailHelp" placeholder="">
                            ...
                            <div class="col-lg-12">
                                <div class="search_btn text-end">
                                    <button type="submit" class="btn btn-primary srch_btn" fdprocessedid="cgqwgp">Update Rate </button>
                                </div>
                            </div>
                    ...
                    <div class="tab-content  text-muted">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{{$editPerson->userName??'N/A'}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="email" value="{{$editPerson->email??'N/A'}}"  aria-describedby="emailHelp" placeholder="" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control onlydate dob_valid" value="{{$editPerson->dob??'N/A'}}" id="basicDate" name="dob"  aria-describedby="emailHelp" placeholder="">
                                        ...
                                        {{-- <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="Staff" value="{{$editPerson->selectPersonType ??'N/A'}}" name="selectPersion" id="autoSizingCheck1a" {{ $editPerson->selectPersonType??'N/A' == "Staff" ? 'checked' : '' }} >
                                                    <label class="form-check-label" for="autoSizingCheck1a">
                                                    Staff
                                                        </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="Person" value="{{$editPerson->selectPersonType ??'N/A'}}" name="selectPersion" id="autoSizingCheck1b" {{ $editPerson->selectPersonType??'N/A' == "Person" ? 'checked' : '' }} >
                        ...
                        <div class="main_bx_dt__">
                             <div class="top_dt_sec">
                                <form class="saveclass" id="saveAddress">
                                    <div class="row">
                                        <input type="hidden" name="personValue2" id="personValue2" value="2"/>
                                        <input type="hidden" name="personId"  value="{{ $person }}"/>
                                        <div class="col-lg-12">
                                            <div class="row">
                                            <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="zipCode" id="addZipCode" aria-describedby="emailHelp" placeholder="">
                                                <span class="firstcls1" id="addZipCodeError" class="text-danger" hidden>Please add zip code.</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <span class="firstcls1" id="unitError" class="text-danger" hidden>Please add zip code.</span>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="addressNumber" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exampleInputEmail1">Street Address</label>
                                                <input type="text" class="form-control" name="streetAddress" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exampleInputEmail1">Suburb</label>
                                                <input type="text" class="form-control" name="suburb" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="add_address text-end">
                                                <button type="submit" class="theme_btn btn btn-primary" id="add_person_btn">+ Add Address</button>
                                                ...
                                                <tbody id="personAddress">
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>{{ $alladdress->state }}</td>
                                                         <td>
                                                             <div class="g-2">
                                                                <a onclick="removePerson(this,'{{$alladdress->id}}')" class="btn text-danger btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Delete"><span class="fe fe-trash-2 fs-14"></span></a>
                                                             </div>
                                                         </td>
                                                     </tr>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-4">
                                                        <div class="check_box">
                                                            ...
                                                            <select class="form-control select2 form-select" name="reminderType" data-placeholder="Choose one">

                                                                    @forelse ($reminder as $allreminder)
                                                                    <option value="{{ $allreminder->id }}">{{ $allreminder->reminderName }}</option>
                                                  ...
                                                  @if(isset($editPerson->getreminder))
                                                    @foreach ($editPerson->getreminder as $key=>$Personreminder)
                                                        ...
                                                        <tr class="border-bottom" id="personReminder">
                                                            ...
                                                            <td>{{ $Personreminder->getReminder->reminderName }}</td>
                                                             <td>
                                                                 <div class="g-2">
                                                                    <a onclick="removeReminder(this,'{{$Personreminder->id}}')" class="btn text-danger btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Delete"><span class="fe fe-trash-2 fs-14"></span></a>
                        ...
                        <div class="main_bx_dt__">
                                <div class="top_dt_sec">
                                    <div class="row">
                                        <div class="col-lg-12">
                                        <form id="documentBaseForm" method="post" enctype='multipart/form-data'>
                                            @csrf
                                        <input type="hidden" name="personValue5" value="5"/>
                                        <input type="hidden" name="person_id" value="{{ Request::segment(4)}}" id="person_id"/>
                                            <div class="row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="exampleInputEmail1">Name</label>
                                                    <input type="text" name="document_name" class="form-control" id="firstEdit" aria-describedby="emailHelp" placeholder="">
                                                    <p class="first" id="firstEditError" style="display: none">Please Add Name</p>
                                                </div>
                                            </div>
                                        <div class="col-lg-6">
                                        <div class="mb-3">
                                        <label class="form-label" for="exampleInputEmail1">Status</label>
                                            ...
                                            <select class="form-control select2 form-select" data-placeholder="Choose one" name="document_status">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="check_box">
                                                        <label class="form-label" for="exampleInputEmail1">Upload document</label>
                                                        <div class="form-group">
                                                          <input type="file" class="dropify" id="documentAdd" data-height="100" name="document_file"/>
                                                           <p class="first" id="documentValidation" style="display: none">Document Field is required</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="search_btn text-end">
                                                    <button type="submit" class="btn btn-primary srch_btn">+ Add Document</button>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="check_box">
                                                     ...
                                                     <input type="hidden" name="personValue4" id="personValue4" value="4"/>
                                                     <input type="hidden" name="personId"  value="{{ $person }}"/>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Day</label>
                                                           ...
                                                           <input type="number" name="hourlyRatePayableDay"  min="0"  class="form-control"   aria-describedby="emailHelp" placeholder="">

                                                            <p class="first" id="hourlyRatePayableDayError" style="display: none">Please Add Hourly Rate Payable Day</p>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hourlyRatePayableNight" id="hourlyRatePayableNight2" min="0"  class="form-control fc-datepicker"   aria-describedby="emailHelp" placeholder="">

                                                        <p class="first" id="hourlyRatePayableNightError" style="display: none">Please Add Hourly Rate Payable Night</p>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Saturday</label>
                                                     <input type="text" name="hourlyRatePayableSaturday" id="hourlyRatePayableSaturday3" min="0"  class="form-control fc-datepicker"   aria-describedby="emailHelp" placeholder="">

                                                     <p class="first" id="hourlyRatePayableSaturdayError" style="display: none">Please Add Hourly Rate Payable Saturday</p>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="exampleInputEmail1">Hourly Rate Payable Sunday</label>
                                                    <input type="text" name="hourlyRatePayableSunday" id="hourlyRatePayableSunday4" min="0"  class="form-control fc-datepicker"   aria-describedby="emailHelp" placeholder="">

                                                    <p class="first" id="hourlyRatePayableSundayError" style="display: none">Please Add Hourly Rate Payable Sunday</p>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="exampleInputEmail1">Extra Hourly Rate</label>
                                                            ...
                                                            <input type="text" name="extraHourlyRate" id="extraHourlyRate5" min="0"  class="form-control fc-datepicker"   aria-describedby="emailHelp" placeholder="">

                                                            <p class="first" id="extraHourlyRateError" style="display: none">Please Add Extra Hourly Rate</p>
                                            ...
                                            <table  class="table table-bordered text-nowrap mb-0">
                                                <thead class="border-top">
                                                    <tr>
                                                        ...
                                                        <th class="bg-transparent border-bottom-0">Hourly Rate Payable Sunday</th>
                                                        <th class="bg-transparent border-bottom-0">Extra Hourly Rate</th>
                                                        <th class="bg-transparent border-bottom-0" style="width: 5%;">Action</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody id="monetizeIdAppend">
                                                    @forelse ($personRating as $alllpersonRating)
                                                       <tr class="border-bottom">
                                                        @php
                                                         $typeName= DB::table('types')->orderBy('id','DESC')->where('id',$alllpersonRating->type)->first()->name??'N/A';
                                                        @endphp
                                                       <td>{{ $typeName}}</td>
                                                       <td>{{ $alllpersonRating->hourlyRatePayableDays }}</td>
                                                       <td>{{ $alllpersonRating->hourlyRatePayableNight }}</td>
                                                       <td>{{ $alllpersonRating->hourlyRatePayableSaturday }}</td>
                                                       <td>{{ $alllpersonRating->hourlyRatepayableSunday }}</td>
                                                       <td>{{ $alllpersonRating->extraHourlyRate }}</td>
                                                       <td>
                                                        <div class="g-2">
                                                            <a onclick="editRate('{{ $alllpersonRating->type }}','{{ $alllpersonRating->hourlyRatePayableDays??'N/A'}}','{{ $alllpersonRating->hourlyRatePayableNight??'N/A'}}','{{ $alllpersonRating->hourlyRatePayableSaturday??'N/A'}}','{{ $alllpersonRating->hourlyRatepayableSunday??'N/A'}}','{{ $alllpersonRating->extraHourlyRate??'N/A'}}')" class="btn text-primary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Edit"><span class="fe fe-edit fs-14"></span></a>
                                                           <a onclick="removeRate(this,'{{$alllpersonRating->id}}')" class="btn text-danger btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Delete"><span class="fe fe-trash-2 fs-14"></span></a>
                                           ...
                                           swal({
                                               ...
                                               if (Array.isArray(data.documents) && data.documents.length > 0) {
                                                ...
                                                var sno = 1;
                                                        ...
                                                        $("#basic-datatable tbody").append("<tr><td colspan='4'>No documents available</td></tr>");
                                                    }
...
<script>
  ...
  document.getElementById("datePicker").setAttribute("max", getCurrentDate());
    ...
    function editRate(getType,hourlyRateChargeableDays,ourlyRateChargeableNight,hourlyRateChargeableSaturday,hourlyRateChargeableSunday,extraHourlyRate)
    {
        $('#editRate').modal('show');
