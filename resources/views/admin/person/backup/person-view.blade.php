                                ...
                                <div class="top_dt_sec">
                                    ...
                                    <div class="table-responsive">
                                            <table  class="table table-bordered text-nowrap mb-0">
                                                ...
                                                @php
                                                $personrates=App\Models\Personrates::where('personId',$personDetail->id)->OrderBy('id','desc')->get();
                                                $i=1;
                                                @endphp
                                                <tbody>
                                                    @foreach ($personrates as $allpersonrates)
                                                    <tr class="border-bottom">
                                                       <td>{{ App\Models\Type::OrderBy('id','desc')->where('id',$allpersonrates->type)->first()->name??'N/A' }}</td>
                                                       <!-- <td></td>
                                                       <td></td>
                                                       <td></td>
                                                       <td></td> -->
                                                       <td>{{ $allpersonrates->hourlyRatePayableDays	 }}</td>
                                                       <td>{{ $allpersonrates->hourlyRatePayableNight	 }}</td>
                                                       <td>{{ $allpersonrates->hourlyRatePayableSaturday	 }}</td>
                                                       <td>{{ $allpersonrates->hourlyRatepayableSunday }}</td>
